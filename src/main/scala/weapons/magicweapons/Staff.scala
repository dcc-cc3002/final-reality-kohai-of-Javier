...
class Staff(name: String, attackPoints: Int, magicAttack: Int, weight: Int, owner: WCharacter) extends AbstractMagicWeapon(name, attackPoints, magicAttack, weight, owner) {
     ...
     * Otherwise, it throws an IncompatibleWeaponException.*/
     def checkPaladin: Boolean = throw new IncompatibleWeaponException("Staff")

    /** Checks whether this weapon can be equiped to a Warrior.
     * Otherwise, it throws an IncompatibleWeaponException.*/
     def checkWarrior: Boolean = throw new IncompatibleWeaponException("Staff")

    /** Checks whether this weapon can be equiped to a Ninja.
     * Otherwise, it throws an IncompatibleWeaponException.*/
     def checkNinja: Boolean = throw new IncompatibleWeaponException("Staff")
